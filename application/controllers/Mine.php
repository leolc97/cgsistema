...
class Mine extends CI_Controller
{
    ...
    public function visualizarOs($id = null)
    {
        ...
        $totais = $this->os_model->valorTotalOS($this->uri->segment(3));
        $data['totalServico'] = $totais['totalServico'];
        $data['totalProdutos'] = $totais['totalProdutos'];
        $data['valorTotal'] = $totais['totalServico'] + $totais['totalProdutos'];
    ...
    public function visualizarCompra($id = null)
    {
        ...
        $data['emitente'] = $this->mapos_model->getEmitente();
        $data['anexos'] = $this->vendas_model->getAnexos($this->uri->segment(3));
