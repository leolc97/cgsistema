...
class MercadoPago extends BasePaymentGateway
{
    ...
    {
        $resultos = $this->ci->Os_model->valorTotalOS($id);
        $resultvenda = $this->ci->vendas_model->getById($id);
        ...
        $desconto = [$tipo === PaymentGateway::PAYMENT_TYPE_OS
            ? $this->ci->Os_model->valorTotalOS($id)
        ...
        $valor= [$tipo === PaymentGateway::PAYMENT_TYPE_OS
            ? $resultos["valor_desconto"]
            : $resultvenda->descontovenda];
        ...
        $payment = new Payment();
        $payment->transaction_amount = floatval($this->valorTotal($totalProdutos, $totalServicos, $valor[0]));
        ...
        $data = [
            ...
            'status' => $payment->status,
            'total' => getMoneyAsCents($this->valorTotal($totalProdutos, $totalServicos, $valor[0])),
