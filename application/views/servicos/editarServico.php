            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formServico" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="nome" class="span8" type="text" name="nome" value="<?php echo $result->nome ?>" placeholder="Ex. Formatação, Limpeza..." />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="preco" class="control-label"><span class="required">Preço*</span></label>
                        <div class="controls">
                            <input id="preco" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="preco" value="<?php echo $result->preco ?>" placeholder="Ex. 10.00" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label">Descrição</label>
                        <div class="controls">
                            <input id="descricao" class="span8" type="text" name="descricao" value="<?php echo $result->descricao ?>" placeholder="Ex. Formatação - Windows 10 Com Backup" />
                        </div>
                    </div>
