            ...
            <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label for="contato" class="control-label">Falar Com:</label>
                            <div class="controls">
                                <input class="contato" type="text" name="contato" value="<?php echo set_value('contato'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="celular" class="control-label">Celular / Whatsapp<span class="required">*</span></label>
                            <div class="controls">
                        ...
                        <img id="imgSenha" alt=""> <!-- obrigatorio por para aparecer a lista de estados, nao sei pq! -->
                        <div class="control-group">
