...
<head>
    <title>Mine - Área do Cliente - <?php $configuracoes = $this->db->get('configuracoes')->result();
  ...
  <div class="row-fluid" style="width: 100vw;height: 100vh;display: flex;align-items: center;justify-content: center">
    ...
    <div class="row-fluid">
        <div id="footer" class="span12" style="padding: 10px"> <a class="pecolor" href="https://github.com/RamonSilva20/mapos" target="_blank">
            <?= date('Y') ?> &copy; Ramon Silva - <?php $configuracoes = $this->db->get('configuracoes')->result();
echo $configuracoes[0]->valor?> - Versão: <?= $this->config->item('app_version'); ?>
        </a></div>
    </div>
