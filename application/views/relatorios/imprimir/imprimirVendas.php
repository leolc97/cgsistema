...
<head>
    <title>Relatório de Vendas - <?= $emitente[0]->nome ?></title>
    <meta charset="UTF-8" />
                        ...
                        <table width="100%" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($vendas as $v) {
                                    ...
                                    echo '<td align="center">R$: ' . number_format($v->valorTotal + $v->descontovenda, 2, ',', '.') . '</td>';
                                    echo '<td align="center">R$: ' . number_format($v->descontovenda, 2, ',', '.') . '</td>';
