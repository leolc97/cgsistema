...
<div class="span12" style="margin-left: 0">
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Em Andamento</h5>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($andamento != null) : ?>
                            <?php foreach ($andamento as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
                                    <td>
                                        <?= date('d/m/Y H:i:s', strtotime($o->dataInicial)) ?>
                                    </td>
                                    ...
                                    <td>
                                        <?= number_format($o->valorTotal, 2, ',', '.') ?>
                                    </td>
                                    <td>
                                        <?= number_format(floatval($o->valorTotal - $o->descontoproduto - $o->descontoservico), 2, ',', '.') ?>
                                    </td>
                                    <td>
                                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                                        ...
                                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                                            <a href="<?= base_url() ?>index.php/os/editar/<?= $o->idOs ?>" class="btn-nwe">
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Aguardando Análise Técnica</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($aguardandotec != null) : ?>
                            <?php foreach ($aguardandotec as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="5">Nenhuma OS Aguardando Análise Técnica.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Aguardando aprovação do cliente</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($aguardandocl != null) : ?>
                            <?php foreach ($aguardandocl as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="5">Nenhuma OS Aguardando aprovação do cliente.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Aguardando Peças</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($aguardandop != null) : ?>
                            <?php foreach ($aguardandop as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Aguardando Retirada - Cliente já Informado(a)</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($aguardandoret != null) : ?>
                            <?php foreach ($aguardandoret as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="5">Nenhuma OS Aguardando Retirada - Cliente já Informado(a).</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Entregue - A Receber</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($entreguerec != null) : ?>
                            <?php foreach ($entreguerec as $o) : ?>
                                <tr>
                                    <td>
                                        <?= $o->idOs ?>
                                    </td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="5">Nenhuma OS Entregue - A Receber.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box">
        <div>
            <h5 class="cardHeader">Garantia</h5>
        </div>
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="5">Nenhuma OS em garantia.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
