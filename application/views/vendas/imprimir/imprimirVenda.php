...
<html>
<head>
    <title>Venda <?php echo $result->idVendas ?> - <?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
    <head>
<meta charset="utf-8">
...
<i class="fas fa-phone-alt" style="margin:4px 1px"></i> <?php echo 'Whatsapp: ' . $emitente[0]->telefone; ?></td>

        
<td style="text-align: center">
        <span style="font-size: 10px"><b>Venda Nº: </b><?php echo $result->idVendas ?></span></br>
        <span style="font-size: 10px"><b>Data da Venda: </b><?php echo date('d/m/Y H:i:s', strtotime($result->dataVenda)); ?> <br>
...
<th><span style="font-size: 15px"><center><b>IMPRESSÃO DA VENDA</b></center></span></th>
      ...
      <div style="margin-top: 0; padding-top: 0">
                    ...
                    <?php if ($result->rastreio != null) { ?>
                      ...
                      if ($totalProdutos != 0 || $totalServico != 0) {
                            ...
                            echo "<h6 style='text-align: right'>Total Com Desconto R$: " . number_format($totalProdutos - $result->descontovenda, 2, ',', '.') . "</h7>";}?><br>
...
<br>
    <center><span style="font-size: 13px"><b>Termo de Venda</b></span></center>
    <br>
                                   </div>
                                   </div>
                                   </div>
...
<br>  <table width="100%" style="font-size: 10px" class="table table-bordered table-condensed">
...
<br>
 <br>
  ...
  <tr>
    <td><div style="font-size: 10px" align="center"><b>Assinatura do Vendedor</b></div> <br> 
                                    <div style="font-size: 11px" align="center"><?php echo $result->nome ?></div>
                                    <hr></td>

                        
    <td><div style="font-size: 10px" align="center"><b>Assinatura do Cliente</b></div> <br>
