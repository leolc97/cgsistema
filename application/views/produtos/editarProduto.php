            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="codDeBarra" type="text" name="codDeBarra" value="<?php echo $result->codDeBarra; ?>" placeholder="Ex. 52745749577..."  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label">Nome do Produto<span class="required">*</span></label>
                        <div class="controls">
                            <input id="descricao" class="span8" type="text" name="descricao" value="<?php echo $result->descricao; ?>" placeholder="Ex. Computador Gamer Pichau, Ryzen 5 3600..." />
                        </div>
                    </div>
                    ...
                    <div class="controls">
                                        <textarea class="span8 editor" name="descricaoproduto" id="descricaoproduto" cols="500"
                                                  rows="6" placeholder="Ex. Configuração: Processador Ryzen 5 3600, 6 núcleo 12 threads 32mb cache, 16Gb de memória ram, SSD 120gb, HD 1000gb velocidade 7200RPM, Fonte 600watts 80 plus, RX 570 4gb 256bits, Placa de rede 10/1000 GigaLan, Gabinete Gamer camuflado porta de vidro temperado com 4 fan!"><?php echo $result->descricaoproduto ?></textarea>           
                                                  </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoCompra" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoCompra" value="<?php echo $result->precoCompra; ?>" placeholder="Ex. 3.780,00" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoVenda" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoVenda" value="<?php echo $result->precoVenda; ?>" placeholder="Ex. 4.220,00" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoque" type="text" name="estoque" value="<?php echo $result->estoque; ?>" placeholder="Ex. 10" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoqueMinimo" type="text" name="estoqueMinimo" value="<?php echo $result->estoqueMinimo; ?>" placeholder="Ex. 1" />
                        </div>
                    </div>
